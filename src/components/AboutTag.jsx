...
function AboutTag(props) {
  return (
    <div className="p-4 flex items-center gap-10 rounded-xl hover:bg-neutral-900 hover:translate-x-3 transition-all">
      ...
      <div>
        <h1 className="text-xl font-semibold pl-3 border-l-4 border-l-cyan-400">{props.title}</h1>
